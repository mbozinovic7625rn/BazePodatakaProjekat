...
--
-- Table structure for table `eksperiment_tip_alata`
--
...
--
-- Dumping data for table `eksperiment_tip_alata`
--

LOCK TABLES `eksperiment_tip_alata` WRITE;
/*!40000 ALTER TABLE `eksperiment_tip_alata` DISABLE KEYS */;
/*!40000 ALTER TABLE `eksperiment_tip_alata` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-05 22:50:33
