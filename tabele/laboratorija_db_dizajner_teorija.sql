...
--
-- Table structure for table `dizajner_teorija`
--
...
--
-- Dumping data for table `dizajner_teorija`
--

LOCK TABLES `dizajner_teorija` WRITE;
/*!40000 ALTER TABLE `dizajner_teorija` DISABLE KEYS */;
/*!40000 ALTER TABLE `dizajner_teorija` ENABLE KEYS */;
UNLOCK TABLES;
