...
--
-- Table structure for table `sesija_alat`
--
...
--
-- Dumping data for table `sesija_alat`
--

LOCK TABLES `sesija_alat` WRITE;
/*!40000 ALTER TABLE `sesija_alat` DISABLE KEYS */;
/*!40000 ALTER TABLE `sesija_alat` ENABLE KEYS */;
UNLOCK TABLES;
