...
--
-- Table structure for table `sesija_resurs`
--
...
--
-- Dumping data for table `sesija_resurs`
--

LOCK TABLES `sesija_resurs` WRITE;
/*!40000 ALTER TABLE `sesija_resurs` DISABLE KEYS */;
/*!40000 ALTER TABLE `sesija_resurs` ENABLE KEYS */;
UNLOCK TABLES;
