...
--
-- Table structure for table `izvodjenje_izvodjac`
--
...
--
-- Dumping data for table `izvodjenje_izvodjac`
--

LOCK TABLES `izvodjenje_izvodjac` WRITE;
/*!40000 ALTER TABLE `izvodjenje_izvodjac` DISABLE KEYS */;
/*!40000 ALTER TABLE `izvodjenje_izvodjac` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-05-05 22:50:32
